...
public class TableViewCheckBoxDemo extends Application {
	...
	private void init(Stage primaryStage) {
		...
		new Person(true, "Jacob", "Smith", "jacob.smith@example.com"),
				...
				new Person(false, "Isabella", "Johnson",
						"isabella.johnson@example.com"),

				new Person(true, "Ethan", "Williams",
				...
				new Person(false, "Michael", "Brown",
		...
		tableView.getColumns().addAll(invitedCol, firstNameCol, lastNameCol,
				emailCol);
	...
	private void updateObservableListProperties(TableColumn emailCol,
		...
		firstNameCol
				.setOnEditCommit(new EventHandler<CellEditEvent<Person, String>>() {
					...
					public void handle(CellEditEvent<Person, String> t) {
						...
						t.getTablePosition().getRow())).setFirstName(t
								.getNewValue());
		...
		lastNameCol
				.setOnEditCommit(new EventHandler<CellEditEvent<Person, String>>() {
					...
					public void handle(CellEditEvent<Person, String> t) {
						...
						t.getTablePosition().getRow())).setLastName(t
								.getNewValue());
	...
	public static class Person {
		...
		private SimpleBooleanProperty invited;
		...
		private Person(boolean invited, String fName, String lName, String email) {
			...
			this.email = new SimpleStringProperty(email);
			  ...
			  System.out.println(firstNameProperty().get() + " invited: " + invitedProperty().getValue().toString());
